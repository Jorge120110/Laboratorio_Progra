...
UX/UI: la interfaz para el usuario debe ser simple, atractiva para el usuario con colores, azules-celestes, verdes claros, blancos, manteniendo una vista sobria.

1.	Ahora, implementa un metodo para traducir la frase motivacional presentada a español, dime si necesitas una api

2.	Ok, pero, necesito que en lugar de un boton para que se traduzca, este sea automatico, aparezca como esta ahora, debajo del ingles, pero sin tener que accionar el botón
...
2.	hola, haz una mejora en la interzas para que se vea mas atractivo visualmente manteniedo un diseño sobrio pero amigable con colores : Blanco, Morado y azul.
